    ...
    private void initEvents() {
        ...
        btnAdd.addActionListener(e -> {
            ...
            if (form.isConfirmed()) {
                if (DAO_Tau.insertTau(form.getEntity())) {
                    ...
                    JOptionPane.showMessageDialog(this, "Lỗi: Mã tàu trùng hoặc sai định dạng!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        btnUpdate.addActionListener(e -> {
            ...
            for (TrangThaiTau t : TrangThaiTau.values()) {
                if (t.getMoTa().equals(moTa)) { tt = t; break; }
            }
        ...
        btnDelete.addActionListener(e -> {
            ...
            String ma = table.getValueAt(row, 1).toString();
            if (JOptionPane.showConfirmDialog(this, "Xóa tàu " + ma + "?", "Xác nhận", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                if (DAO_Tau.deleteTau(ma)) {
                    loadDataFromDatabase();
                    JOptionPane.showMessageDialog(this, "Đã xóa!");
                } else {
                    JOptionPane.showMessageDialog(this, "Không thể xóa do ràng buộc dữ liệu!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
