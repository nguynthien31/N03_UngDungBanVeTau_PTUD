...
public class TAB_Ga_Tuyen extends JPanel {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow == -1) {
                    JOptionPane.showMessageDialog(panel,
                            "Vui lòng chọn một Tuyến trong bảng để xem chi tiết!",
    ...
    private void hienThiPopupGaTrungGian(String maTuyen) {
        ...
        JDialog dialog = new JDialog(parentWindow, "Chi tiết Ga trung gian - Tuyến: " + maTuyen, JDialog.ModalityType.APPLICATION_MODAL);
        ...
        JComboBox<String> cbGa = new JComboBox<>(new String[]{"Nha Trang", "Vinh", "Huế", "Đà Nẵng"}); // Tương lai đổ từ CSDL
        formPanel.add(cbGa);
