...
public class TAB_ThongKeDoanhThu extends JPanel implements ActionListener {
	...
	public TAB_ThongKeDoanhThu() {
		...
		chartPanel.setBorder(BorderFactory.createTitledBorder("Biểu đồ Doanh thu (Cột)"));

		chartDataset = new DefaultCategoryDataset();
		JFreeChart barChart = ChartFactory.createBarChart("", "Ngày", "Doanh thu (VNĐ)", chartDataset,
		...
		tablePanel.setBorder(BorderFactory.createTitledBorder("Bảng chi tiết doanh thu theo ngày"));
	...
	private void loadDuLieuThongKe() {
		...
		JOptionPane.showMessageDialog(this, "Đã cập nhật dữ liệu thống kê!", "Thành công",
