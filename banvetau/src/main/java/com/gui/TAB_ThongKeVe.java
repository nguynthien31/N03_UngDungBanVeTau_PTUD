...
public class TAB_ThongKeVe extends JPanel implements ActionListener {
	...
	public TAB_ThongKeVe() {
		...
		JFreeChart pieChart = ChartFactory.createPieChart("", // Tiêu đề biểu đồ (Để trống vì đã có viền TitledBorder)
				pieDataset, true, // Có hiển thị chú thích (Legend)
				true, false);
	...
	private void loadDuLieuThongKe() {
		...
		// 1. Đổ dữ liệu giả lập vào Bảng (Phù hợp với 4 cột: STT, Tiêu chí, Số lượng,
		// Tỷ lệ)
		...
		JOptionPane.showMessageDialog(this, "Đã cập nhật dữ liệu biểu đồ!", "Thành công",
