...
public class TAB_LichTrinh_ChuyenTau extends JPanel {
    ...
    private JPanel buildFilterCard() {
        ...
        btnTimKiem.addActionListener(_ -> timKiemChuyenTau());
        btnLamMoi.addActionListener(_ -> {
    ...
    private JPanel buildActionBar() {
        ...
        btnThem.addActionListener(_    -> moDialogThem());
        btnCapNhat.addActionListener(_ -> moDialogCapNhat());
        btnXoa.addActionListener(_     -> xoaChuyenTau());
    ...
    private void hienThiDialog(JDialog dialog, JPanel form, JButton btnLuu) {
        ...
        btnHuy.addActionListener(_ -> dialog.dispose());
