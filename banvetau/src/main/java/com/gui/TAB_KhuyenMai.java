...
public class TAB_KhuyenMai extends JPanel {
	...
	private JPanel createFilterPanel() {
		...
		JComboBox<String> status = new JComboBox<>(new String[] { "Tất cả trạng thái", "ACTIVE", "UPCOMING" });
	...
	private JScrollPane createTable() {
		String[] columns = { "#", "Tên CT", "Mã KM", "Loại", "Mức giảm", "Hiệu lực", "Đã dùng", "Trạng thái" };

		Object[][] data = { { "1", "Giảm giá mùa hè", "GIAM20PT", "%", "20%", "13/03 - 23/06", "9", "ACTIVE" },
				{ "2", "Chương trình Tết", "TET2026", "VNĐ", "50,000", "13/03 - 23/06", "26", "UPCOMING" },
				{ "3", "Khuyến mãi tuần", "TUAN70", "%", "70%", "13/03 - 23/06", "1", "ACTIVE" }, };
